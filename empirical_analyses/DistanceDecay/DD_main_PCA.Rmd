...
#act.bray.dist <- act.bray.dist/max(act.bray.dist)

all.bray.dist <- 1 - vegdist(all.com, method="bray", binary=F)
#all.bray.dist <- all.bray.dist/max(all.bray.dist)

act.sore.dist <- 1 - vegdist(act.com, method="bray", binary=T)
#act.sore.dist <- act.sore.dist/max(act.sore.dist)

all.sore.dist <- 1 - vegdist(all.com, method="bray", binary=T)
#all.sore.dist <- all.sore.dist/max(all.sore.dist)

act.canb.dist <- 1 - vegdist(act.com, method="canberra", binary=F)
#act.canb.dist <- act.canb.dist/max(act.canb.dist)

all.canb.dist <- 1 - vegdist(all.com, method="canberra", binary=F)
#all.canb.dist <- all.canb.dist/max(all.canb.dist)
```
